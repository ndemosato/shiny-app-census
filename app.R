...
ui <- dashboardPage(
  ...
  dashboardHeader(
    ...
    tags$li(actionLink("Twitter", 
                       label = "", 
                       icon = icon("twitter"),
                       onclick = "window.open('https://twitter.com/SatoMartin')"),
            class = "dropdown"),
    tags$li(actionLink("GitHub", 
                       label = "", 
                       icon = icon("github"),
                       onclick = "window.open('https://github.com/ndemosato')"),
            class = "dropdown")
  ),
  
  dashboardSidebar(
    
    sidebarUserPanel("Martin Ndemo",
                     subtitle = "Agriculture Economist"
                     ),
    sidebarMenu(
      menuItem(
        "Map",
